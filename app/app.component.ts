  ...
  template: `
    <my-tabs>
      <my-tab [tabTitle]="'People'">
        ...
        <button class="btn btn-default" (click)="onOpenComp1()"><i class="glyphicon glyphicon-question-sign"></i> Comp1</button>
      </my-tab>
    </my-tabs>
    ...
    <ng-template let-person="person" #comp1>
      <app-comp1></app-comp1>
    </ng-template>
    <ng-template #about>
      <p>
...
export class AppComponent {
  ...
  onOpenComp1() {
    this.tabsComponent.openTab('Comp1', this.comp1Template, {}, true);
  }
}
